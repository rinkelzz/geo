...
renderHtml($dbConfig, $mailConfig, $isDbConfigured, $messages, $errors, $sqlResults, file_exists($configPath));
...
function renderHtml(array $dbConfig, array $mailConfig, bool $isDbConfigured, array $messages, array $errors, array $sqlResults, bool $configExists): void
{
...
<body>
    <main class="card">
        ...
        <section>
            ...
            <p>Hinterlege die Verbindungsdaten für deine MySQL/MariaDB-Datenbank sowie die Absenderdaten für Benachrichtigungs-E-Mails. Die Angaben werden in <code>config/config.php</code> gespeichert.</p>
